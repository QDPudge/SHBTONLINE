...
//     重新生成代码，这些更改将会丢失。
// </auto-generated>
// <copyright file="YwTemporaryTaskMap.cs">
...
{
    public class YwTemporaryTaskMap : EntityTypeConfiguration<YwTemporaryTask>
    {
        public YwTemporaryTaskMap()
        {
            // Primary Key
            this.HasKey(t => t.Id);
            ...
            this.Property(t => t.TempTaskType).HasColumnName("TempTaskType");
