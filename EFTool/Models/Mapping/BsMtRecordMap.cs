...
//     重新生成代码，这些更改将会丢失。
// </auto-generated>
// <copyright file="BsMtRecordMap.cs">
...
{
    public class BsMtRecordMap : EntityTypeConfiguration<BsMtRecord>
    {
        public BsMtRecordMap()
        {
            // Primary Key
            this.HasKey(t => t.Id);
            ...
            this.Property(t => t.PurchaseEmpId)
                .IsFixedLength()
                .HasMaxLength(36);
