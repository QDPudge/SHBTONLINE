...
//     重新生成代码，这些更改将会丢失。
// </auto-generated>
// <copyright file="BsMtBuyHistoryMap.cs">
...
{
    public class BsMtBuyHistoryMap : EntityTypeConfiguration<BsMtBuyHistory>
    {
        public BsMtBuyHistoryMap()
        {
            // Primary Key
            this.HasKey(t => t.Id);
            ...
            this.Property(t => t.PurchaseDeptId)
                .IsFixedLength()
                .HasMaxLength(36);
            ...
            this.ToTable("BsMtBuyHistory");
            this.Property(t => t.Id).HasColumnName("Id");
            this.Property(t => t.PurchaseId).HasColumnName("PurchaseId");
            this.Property(t => t.PurchaseDeptId).HasColumnName("PurchaseDeptId");
