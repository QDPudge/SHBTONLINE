...
//     重新生成代码，这些更改将会丢失。
// </auto-generated>
// <copyright file="BsMtWarningMap.cs">
...
{
    public class BsMtWarningMap : EntityTypeConfiguration<BsMtWarning>
    {
        public BsMtWarningMap()
        {
            // Primary Key
            this.HasKey(t => t.Id);
            ...
            this.Property(t => t.WarningType).HasColumnName("WarningType");
            ...
            this.Property(t => t.WarningQuantity).HasColumnName("WarningQuantity");
