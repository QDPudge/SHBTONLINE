...
//     重新生成代码，这些更改将会丢失。
// </auto-generated>
// <copyright file="BsMtCategoryMap.cs">
...
{
    public class BsMtCategoryMap : EntityTypeConfiguration<BsMtCategory>
    {
        public BsMtCategoryMap()
        {
            // Primary Key
            this.HasKey(t => t.Id);
            ...
            this.ToTable("BsMtCategory");
            this.Property(t => t.Id).HasColumnName("Id");
            this.Property(t => t.MtTypeCode).HasColumnName("MtTypeCode");
            this.Property(t => t.MtTypeName).HasColumnName("MtTypeName");
