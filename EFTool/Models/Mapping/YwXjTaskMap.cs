...
{
    public class YwXjTaskMap : EntityTypeConfiguration<YwXjTask>
    {
        public YwXjTaskMap()
        {
            // Primary Key
            ...
            this.Property(t => t.CheckRange).HasColumnName("CheckRange");
