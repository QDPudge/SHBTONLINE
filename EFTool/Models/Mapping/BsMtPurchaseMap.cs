...
//     重新生成代码，这些更改将会丢失。
// </auto-generated>
// <copyright file="BsMtPurchaseMap.cs">
...
{
    public class BsMtPurchaseMap : EntityTypeConfiguration<BsMtPurchase>
    {
        public BsMtPurchaseMap()
        {
            // Primary Key
            this.HasKey(t => t.Id);
            ...
            this.Property(t => t.ApplyCls).HasColumnName("ApplyCls");
            this.Property(t => t.IsEnabled).HasColumnName("IsEnabled");
            this.Property(t => t.PurchaseState).HasColumnName("PurchaseState");
            this.Property(t => t.ApprovalType).HasColumnName("ApprovalType");
            ...
            this.HasOptional(t => t.BsMtMateriale)
                .WithMany(t => t.BsMtPurchases)
                .HasForeignKey(d => d.SpecificationId);
            this.HasOptional(t => t.BsMtRecord)
                .WithMany(t => t.BsMtPurchases)
