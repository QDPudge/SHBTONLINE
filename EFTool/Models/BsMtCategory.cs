...
//     重新生成代码，这些更改将会丢失。
// </auto-generated>
// <copyright file="BsMtCategory.cs">
...
namespace TY.SHMetroPlan.Data.Domain.Models
{
    ...
    /// </summary>
    [Serializable]
    public partial class BsMtCategory : BaseEntity
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public BsMtCategory()
        {
            this.BsMtMateriales = new List<BsMtMateriale>();
        }
        ...
        /// 导航集合：BsMtMateriales
        /// </summary>
        public virtual ICollection<BsMtMateriale> BsMtMateriales { get; set; }
    }
}
